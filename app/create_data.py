...
# --------------------------------------------------------------------------
directors_data = [
    {"name": "Тейлор Шеридан"}, {"name": "Квентин Тарантино"},
    {"name": "Владимир Вайншток"}, {"name": "Декстер Флетчер"},
    {"name": "Стив Энтин"}, {"name": "Роб Маршалл"}, {"name": "Баз Лурман"},
    {"name": "Дэмьен Шазелл"}, {"name": "Пьетро Антон"},
    {"name": "Джеймс Мэнголд"}, {"name": "Дени Вильнёв"},
    {"name": "Кирилл Серебренников"}, {"name": "Рубен Фляйшер"},
    {"name": "Стэнли Кубрик"}, {"name": "Ричард Келли"},
    {"name": "Пит Доктер"}, {"name": "Кемп Пауэрс"},
    {"name": "Бибо Бержерон"}, {"name": "Тоби Генкель"},
    {"name": "Шон Маккормак"}
]
# --------------------------------------------------------------------------
genres_data = [
    {"name": "Комедия"}, {"name": "Семейный"}, {"name": "Фэнтези"},
    {"name": "Драма"}, {"name": "Приключения"}, {"name": "Триллер"},
    {"name": "Фантастика"}, {"name": "Аниме"}, {"name": "Документальное"},
    {"name": "Короткометражка"}, {"name": "Ужасы"}, {"name": "Боевик"},
    {"name": "Мелодрама"}, {"name": "Детектив"}, {"name": "Авторское кино"},
    {"name": "Мультфильм"}, {"name": "Вестерн"}, {"name": "Мюзикл"}
]
